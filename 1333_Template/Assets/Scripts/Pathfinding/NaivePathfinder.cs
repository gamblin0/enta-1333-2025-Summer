...
public class NaivePathfinder
{
    ...
    public NaivePathfinder(System.Func<Vector2Int, List<Vector2Int>> getNeighbours, bool allowDiagonal = true, int maxPathlength = 100)
    {
    ...
    {
        //calculate whcih direction has the larger difference
        ...
        else
        {
            ...
            //if the vertical movement failed, try horizontal
            int signX = target.x > current.x ? 1 : -1;
